...
<link rel="stylesheet" href="../css/top.css">
       ...
       <div class="contents">
                ...
                <p class="text">
                特殊文字を適切に処理できていないと、スクリプトを実行できてしまったり、意図しない動作が行われる可能性があります。例を挙げるとSQLインジェクションやXXSなどです。これらの脆弱性は実際に体験してみないと理解をすることが難しいと考えました。脆弱性を実際に攻撃できる謎解きサイトです。ただ単にコピペで入力して処理を実行するだけでは面白みがないのでCTFで使われているflagのようなものを用意することで脆弱性の学習と同時に謎解きも楽しめるというサイトです。
                </p>
